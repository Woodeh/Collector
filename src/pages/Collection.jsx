...
import { LayoutGrid, Loader2, Tag, Trash2, User, Plus, Search, X } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-10 border-b border-[#333] pb-8 gap-6">
          ...
          <div className="flex flex-col md:flex-row w-full xl:w-auto gap-4">
            {/* Search Input */}
            <div className="relative group flex-grow md:w-80 text-left">
              <Search
          ...
          {filteredFigures.map((figure) => (
            ...
            >
              <button
                ...
                className="absolute top-4 right-4 z-30 bg-[#121212]/80 hover:bg-red-600 text-gray-500 hover:text-white p-2 rounded-xl opacity-0 group-hover:opacity-100 transition-all duration-300 backdrop-blur-md border border-white/5"
              >
                <Trash2 size={18} />
              </button>
              ...
              <div className="p-7 flex-grow flex flex-col justify-between">
                <div className="text-left space-y-4">
                  <div className="flex justify-between items-center gap-2">
                    <p className="text-[9px] text-blue-500 font-black uppercase tracking-[0.3em] opacity-80 leading-none truncate max-w-[70%]">
                      {figure.anime}
                    </p>
                    <span
