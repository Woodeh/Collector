...
import { Plus, Loader2, X, Heart, Link, ExternalLink, Trash2 } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-[#121212] p-6 text-[#e4e4e4]">
      <div className="max-w-7xl mx-auto text-left">
        ...
        {/* Сетка хотелок (как в коллекции) */}
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
          {items.map((item) => (
            <div
              key={item.id}
              className="bg-[#1a1a1a] border border-[#333] rounded-[2rem] p-6 relative group overflow-hidden"
            >
                ...
                <div className="flex items-center justify-between mt-6">
                  ...
                  {item.link && (
                    <a
                      ...
                      className="bg-[#222] hover:bg-[#333] p-3 rounded-xl text-orange-500 transition-all"
                    >
