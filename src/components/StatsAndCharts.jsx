...
const StatsAndCharts = ({ collectionStats, preorderStats, wishlistStats, animeData }) => {
  return (
    <div className="lg:col-span-4 space-y-8">
      ...
      <div className="bg-[#1a1a1a] border border-[#333] p-8 rounded-[3rem] space-y-6 shadow-2xl text-left">
        ...
        <div className="space-y-4 text-left">
          {[
            ...
            <div
              key={i}
              className="flex items-center gap-4 p-4 bg-[#121212] rounded-2xl border border-white/5 transition-all hover:border-white/10 text-left"
            >
      ...
      <div className="bg-[#1a1a1a] border border-[#333] p-8 rounded-[3rem] shadow-2xl h-[400px] text-left">
        <h4 className="text-[10px] font-black text-gray-600 uppercase tracking-[0.3em] italic mb-6 text-left">
          Top Franchises
        </h4>
